...
**Citation:** Oyeniran, O. (2026). Iris Recognition with Adaptive Elliptical Mesh Normalization. GitHub repository: https://github.com/yourusername/IrisRecognition_AEMN
